        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                    ...
                    <a href="/">
                        ...
                        @if (Config('dyndash.application-mark'))
                            <img src="{{ asset(Config('dyndash.application-mark')) }}" class="block h-10 w-auto"
                                alt="App logo">
                        @else
                            <x-dashcomp::menu.application-mark class="block h-10 w-auto" />
                        @endif
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-dashcomp::menu.nav-link :active="$item['active']" href="{{ route($item['route'], [$item['parameter'] ?? null]) }}">
                        {{ $item['name'] }}
                    ...
                    <x-dashcomp::menu.dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dashcomp::menu.dropdown-link href="{{ route('logout') }}" onclick="event.preventDefault();
        ...
        <div class="border-t border-gray-200 pt-4 pb-1">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-dashcomp::menu.responsive-nav-link href="{{ route('logout') }}" onclick="event.preventDefault();
                                    this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-dashcomp::menu.responsive-nav-link>
                </form>
